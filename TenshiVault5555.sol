...
import "https://github.com/nabil-boudouch/tenshiContracts/blob/main/TenshiToken5555.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";


contract TenshiVault5555 is Ownable, IERC721Receiver {
  ...
  TenshiToken5555 token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(ERC721Enumerable _nft, TenshiToken5555  _token) { 
    nft = _nft;
    token = _token;
  }
